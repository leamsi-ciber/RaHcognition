                ...
                switch (eachLabel){
                    case "GOOD":
                        ...
                        try {
                            ...
                            String text = "In case you see this message, is because everything is Okay";
                        ...
                        break;
                    case "INJURED":
                        textView.append("PLAY COVID-19 VIDEO");

                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=7tgm8KBlCtE")));
                    ...
                    case "HELP":
                        ...
                        break;
                    case "CPR":
                        textView.append("PLAY HEART ATTACK VIDEO");
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?time_continue=3&v=hekjiCqb9-g&feature=emb_logo")));
                        Log.i("Video", "Video Playing....");
                        break;
                    case "CALL":
